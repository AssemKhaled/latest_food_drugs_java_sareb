...
@CrossOrigin
@Component
@RequestMapping(path = "/pointsSFDA")
public class PointsRestControllerSFDA {
	...
	@Autowired
	private PointsServiceImplSFDA pointsServiceImplSFDA;
	...
	public ResponseEntity<?> getPointsList(@RequestHeader(value = "TOKEN", defaultValue = "")String TOKEN,
		...
		return pointsServiceImplSFDA.getPointsListSFDA(TOKEN,userId,offset,search,active,exportData);
	...
	@RequestMapping(value = "/activePoints", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<?> activePoints(@RequestHeader(value = "TOKEN", defaultValue = "")String TOKEN,
			                                            @RequestParam (value = "PointId", defaultValue = "0") Long PointId,
			                                            @RequestParam (value = "userId", defaultValue = "0") Long userId) {

    	return  pointsServiceImplSFDA.activePoints(TOKEN,PointId,userId);
