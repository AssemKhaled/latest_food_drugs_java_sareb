 ...
 */
@RestController
@RequestMapping(path = "/geofencesSFDA")
@CrossOrigin
public class GeofenceRestControllerSFDA {
	
	@Autowired
	private GeofenceServiceImpl geofenceServiceImpl;
	
	@Autowired
	private GeofenceServiceImplSFDA geofenceServiceImplSFDA;
	...
	public @ResponseBody ResponseEntity<?> getGeofences(@RequestHeader(value = "TOKEN", defaultValue = "")String TOKEN,
    	...
    	return  geofenceServiceImplSFDA.getAllGeofencesSFDA(TOKEN,id,offset,search,active,exportData);
	...
	@RequestMapping(value = "/activeGeofence", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<?> activeGeofence(@RequestHeader(value = "TOKEN", defaultValue = "")String TOKEN,
			                                            @RequestParam (value = "geofenceId", defaultValue = "0") Long geofenceId,
			                                            @RequestParam (value = "userId", defaultValue = "0") Long userId) {

    	return  geofenceServiceImplSFDA.activeGeofence(TOKEN,geofenceId,userId);
